...
class Field_Categories_nested_list_relationship
{
	public $field_type_name			= 'Nested List Relationship for Categories';

	public $field_type_slug			= 'categories_nested_list_relationship';
	
	public $db_col_type				= 'text';

	public $alt_process				= true;

	public $custom_parameters		= array('nested_list_stream', 'allow_disabled', 'instance_id');
	...
	{
		$this->CI->type->add_css('categories_nested_list_relationship', 'nested_list_relationship.css');
	}
	...
	public function form_output($data, $entry_id, $field)
	{
		...
		// Get the tree
		$data['tree'] = $this->_get_tree($nested_list_stream, $data['custom']['instance_id']);
		...
		// Build that fucker
		return $this->CI->type->load_view('categories_nested_list_relationship', 'tree_form', $data);
	}
	 ...
	 * @return array
	 */
	public function _get_tree($stream,$instance_id)
	{
